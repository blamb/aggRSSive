...
- **Second starter collection**: *GenAI in higher education*, 55 verified feeds tagged by stance and credibility tier.
...
- **Moodle and other LMSs**: LTI 1.3 Advantage with a content picker; instructors add live lists to courses.
- **First release**: sources with feed discovery, OPML import, shared tags, the Heart-Cart, rules and curation, embed code and feeds.
